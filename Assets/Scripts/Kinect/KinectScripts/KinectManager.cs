...
public class KinectManager : MonoBehaviour
{
	...
	public bool userFounded = false;
	public static bool iniciado = false;
	// variavel's criada por mim para erros.
	...
	// para não aterar a privada que já tem aqui
			...
			if(Player1Calibrated)
			{
				...
				foreach(KinectGestures.GestureData gestureData in player1Gestures)
				{
					if(gestureData.complete)
					{
						...
						{
							//player1Gestures[i].complete = false;
					...
					else if(gestureData.progress >= 0.1f)
					{
							...
							gestureData.progress >= 0.5f)
						{
							if(HandCursor1 != null)
							{
                                ...
                                //HandCursor1.transform.position = gestureData.screenPos *16; 
                                //aparentemente gestureData.screepos me retorna um valor de 0 a 1 no vector2
								HandCursor1.transform.position = Vector3.Lerp(HandCursor1.transform.position, gestureData.screenPos*22, 0.15f);
                            ...
                            gestureData.progress >= 0.5f)
                        {
                            if (HandCursor2 != null)
                            {
                                HandCursor2.transform.position = Vector3.Lerp(HandCursor2.transform.position, gestureData.screenPos * 16, 2 * Time.deltaTime);
                            }
					...
					else if(gestureData.progress >= 0.1f)
					{
							...
							gestureData.progress >= 0.5f)
						{
							if(HandCursor1 != null)
							{
								//HandCursor1.transform.position = gestureData.screenPos *16; 
								//aparentemente gestureData.screepos me retorna um valor de 0 a 1 no vector2
								HandCursor1.transform.position = Vector3.Lerp(HandCursor1.transform.position, gestureData.screenPos*16, 2*Time.deltaTime);
